...
const Fil1 = () => {
  const cast = [
    ...
    'Delilah Hamlin', 'Leah Jeffries', 'Jennifer Garner', 'Wesley Snipes',
    'Channing Tatum', 'Chris Evans', 'Sofia Helin', 'Marc Healton',
    'Aaron Stafford', 'Tyler Mane', 'Karen Gillan', 'Adrian Ahmed'
  ];

  const [reviews, setReviews] = useState([
    { username: 'tmntmask', review: 'This might be the greatest rom-com ever made', likes: 12533 }
  ]);
  ...
  console.log('Fil1 component rendered');

  return (
    <div className="main-container">
      <h1>Fil1 Component</h1>
