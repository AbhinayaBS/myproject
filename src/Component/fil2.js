      ...
      <div className="main-row">
        <div className="main-left-column">
          <div className="main-poster">
            <img src="rev2.jpg" alt="Movie Poster" />
          </div>
        ...
        <div className="main-middle-column">
          <div className="main-details">
            <h1>Another Movie</h1>
            <p><strong>2024</strong> Directed by Some Director</p>
            <p>A great storyline.</p>
        ...
        <div className="main-part4th">
          ...
          <div className="main-ratings">
            ...
            <div className="main-rating-graph">
              <div className="main-rating-bar" style={{ width: '60%' }}>5 ★★★★★</div>
